...
public class AFragment extends DialogFragment {
    ...
    public static AFragment newInstance(String imgPath, String linkPath, boolean isShowNo) {
        AFragment fragment = new AFragment();
        Bundle bundle = new Bundle();
        bundle.putString("imgPath", imgPath);
        bundle.putString("linkPath", linkPath);
        bundle.putBoolean("isShowNo", isShowNo);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_activites_sheet, container, false);
        ...
        linkPath = bundle.getString("linkPath");
        isShowNo = bundle.getBoolean("isShowNo");
        initView(v);
        return v;
    }
}    
