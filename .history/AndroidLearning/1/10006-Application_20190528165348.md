...
registerActivityLifecycleCallbacks 和 unregisterActivityLifecycleCallbacks 函数，registerActivityLifecycleCallbacks对应用程序内所有 Activity 的生命周期监听，当应用程序内 Activity生命周期发生变化时就会调用，ActivityLifecycleCallbacks接口里面有对应的方法。unregisterActivityLifecycleCallbacks注销
